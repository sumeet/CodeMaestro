    ...
    lang::Value::new_future(async {
        match value {
            lang::Value::Future(value_future) => {
                ...
                let awaited_value = value_future.await;
            ...
            | lang::Value::String(_)
            | lang::Value::Number(_)
            | lang::Value::Boolean(_) | lang::Value::AnonymousFunction(_) => value,
        }
    })
}
...
pub async fn resolve_all_futures(mut val: lang::Value) -> lang::Value {
    while contains_futures(&val) {
        ...
        val = match val {
            lang::Value::Future(value_future) => value_future.await,
            _ => val,
        }
    }
    val
...
fn contains_futures(val: &lang::Value) -> bool {
    match val {
        ...
        | lang::Value::String(_)
        | lang::Value::Number(_)
        | lang::Value::Boolean(_) | lang::Value::AnonymousFunction(_) => false,
    }
}
